...
X2 = { 1, 2, 4 }
Y2 = { 8, 16, 32}
a = {x*y for x in X2 for y in Y2 if x != y}
...
value_list_modified_1 = [x.get(k, 'NOT PRESENT') for x in dlist]
k = 'Frodo'
value_list_modified_2 = [x.get(k, 'NOT PRESENT') for x in dlist]
...
#representation_dict = { x: (x/base**2%base, x/base**1%base, x%base) for x in range(base**3) }
